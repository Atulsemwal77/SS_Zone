...
const AdminCourse = () => {
  ...
  return (
    <>
      ...
      <div className="grid gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 mt-6 px-4 mb-8">
          ...
          filteredCoursesMain.map((data, index) => (
            ...
            >
              <div className="relative">
                ...
                <button className="absolute top-3 left-3 text-white bg-[#296AD2] px-3 py-1 rounded-full text-xs font-semibold">
                  <span className="flex items-center gap-1">
                    ...
                    {data.durationHour}h {data.durationMinute}m
                  </span>
                </button>
              </div>
              ...
              <div className="flex justify-between items-center mt-4">
                ...
                <Link
                  to={`/admin/adminCourseDetails/${data._id}`}
                  state={data}
